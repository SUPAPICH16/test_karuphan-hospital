...
try:
    ...
    #Test-02 เช็กอีเมลและรหัสไม่ถูก In
    driver.find_element(By.XPATH,"/html/body/div[1]/form/input").send_keys("napass.sirikarn122@gmail.com")
    driver.find_element(By.XPATH,"/html/body/div[1]/form/div[1]/input").send_keys("napass")
    ...
    driver.save_screenshot(os.path.join(folder_name, "TC_INLogin_02.png"))
    time.sleep(1)
